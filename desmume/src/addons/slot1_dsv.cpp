...
class Slot1_dsVision : public ISlot1Interface, public ISlot1Comp_Protocol_Client
{
private:
    EMUFILE *img;
...
public:
    ...
    {
        static Slot1InfoSimple info("DSV", "Slot1 dsVision emulation", NDS_SLOT1_DSVISION);
        return &info;
    }
...
ISlot1Interface* construct_Slot1_dsVision() { return new Slot1_dsVision(); }
